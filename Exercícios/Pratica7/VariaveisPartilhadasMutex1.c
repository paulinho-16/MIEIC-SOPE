...
// Testar com ./VariaveisPartilhadasMutex1 1000000 5, por exemplo

// alínea b)
// Estes erros aparecem uma vez que, não havendo sincronização, os valores estarão sempre a ser
// alterados pelas outras threads, logo o conteúdo de array[i] vai ser diferente de i
